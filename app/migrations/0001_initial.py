    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ccat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.cateogery')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='cat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.subcateogery'),
        ),
    ]
